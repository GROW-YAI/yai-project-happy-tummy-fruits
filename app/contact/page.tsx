                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mb-8">
                                Have questions about our products, wholesale orders, or anything else?
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">contact@happytummyfoods.com</p>
                                        <p className="text-gray-600">support@happytummyfoods.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Natural Foods District</p>
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-200">
                                ...
                                <div className="flex space-x-4">
                                    <a href="#" className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-green-600 hover:bg-green-200 transition-colors">
